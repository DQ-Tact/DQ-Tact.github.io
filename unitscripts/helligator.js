...
var AwkStatBuff =   {"5":{"hp":0,"mp":0,"atk":0,"def":40,"agl":0,"wis":0,"move":0}
                    ,"4":{"hp":0,"mp":0,"atk":0,"def":20,"agl":0,"wis":0,"move":0}
                    ,"3":{"hp":0,"mp":0,"atk":0,"def":20,"agl":0,"wis":0,"move":0}
...
function applyStats() {
    $('#HP').text(Math.floor((1057 + (AwkStatBuff[Awk] ? AwkStatBuff[Awk].hp : 0)) * ((AwkStatsUp[Awk] ? AwkStatsUp[Awk].hp : 0) + (ElementalStatsUp[Elemental] ? ElementalStatsUp[Elemental].hp : 0))));
    ...
    $('#ATK').text(Math.floor((427 + (AwkStatBuff[Awk] ? AwkStatBuff[Awk].atk : 0)) * (AwkStatsUp[Awk] ? AwkStatsUp[Awk].atk : 0)));
