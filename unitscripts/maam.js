...
var TalentBlossomStats = {"code":null,"hp":120,"mp":10,"atk":10,"def":20,"agl":10,"wis":10,"move":1,"stype":null};
...
function applyStats() {
    ...
    $('#MP').text(Math.floor((167 + (AwkStatBuff[Awk] ? AwkStatBuff[Awk].mp : 0) + (FullTalent ? TalentBlossomStats.mp : 0)) * ((AwkStatsUp[Awk] ? AwkStatsUp[Awk].mp : 0) + (ElementalStatsUp[Elemental] ? ElementalStatsUp[Elemental].mp : 0))));
