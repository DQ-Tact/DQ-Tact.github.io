...
var TalentBlossomStats = {"code":null,"hp":600,"mp":0,"atk":0,"def":0,"agl":0,"wis":0,"move":0,"stype":null};
...
function applyStats() {
    ...
    $('#MP').text(Math.floor((483 + (AwkStatBuff[Awk] ? AwkStatBuff[Awk].mp : 0) + (FullTalent ? TalentBlossomStats.mp : 0)) * ((AwkStatsUp[Awk] ? AwkStatsUp[Awk].mp : 0) + (ElementalStatsUp[Elemental] ? ElementalStatsUp[Elemental].mp : 0))));
