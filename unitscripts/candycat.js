...
var AwkStatBuff =   {"5":{"hp":0,"mp":0,"atk":0,"def":0,"agl":10,"wis":0,"move":0}
                    ,"4":{"hp":0,"mp":0,"atk":0,"def":0,"agl":10,"wis":0,"move":0}
                    ,"3":{"hp":0,"mp":0,"atk":0,"def":0,"agl":10,"wis":0,"move":0}
                    ,"2":{"hp":0,"mp":0,"atk":0,"def":0,"agl":10,"wis":0,"move":0}
                    ,"1":{"hp":0,"mp":0,"atk":0,"def":0,"agl":10,"wis":0,"move":0}
...
var TalentBlossomStats = {"hp":70,"mp":20,"atk":10,"def":15,"agl":10,"wis":10,"move":1};
...
function applyStats() {
    $('#HP').text(Math.floor((275 + (AwkStatBuff[Awk] ? AwkStatBuff[Awk].hp : 0) + (FullTalent ? TalentBlossomStats.hp : 0)) * ((AwkStatsUp[Awk] ? AwkStatsUp[Awk].hp : 0) + (ElementalStatsUp[Elemental] ? ElementalStatsUp[Elemental].hp : 0))));
    $('#MP').text(Math.floor((95 + (AwkStatBuff[Awk] ? AwkStatBuff[Awk].mp : 0) + (FullTalent ? TalentBlossomStats.mp : 0)) * ((AwkStatsUp[Awk] ? AwkStatsUp[Awk].mp : 0) + (ElementalStatsUp[Elemental] ? ElementalStatsUp[Elemental].mp : 0))));
    $('#ATK').text(Math.floor((193 + (AwkStatBuff[Awk] ? AwkStatBuff[Awk].atk : 0) + (FullTalent ? TalentBlossomStats.atk : 0)) * (AwkStatsUp[Awk] ? AwkStatsUp[Awk].atk : 0)));
