    ...
    var TalentBlossomStats = {"code":null,"hp":50,"mp":20,"atk":10,"def":15,"agl":10,"wis":10,"move":0,"stype":null};
    ...
    function applyStats() {
        ...
        $('#AGL').text(Math.floor((128 + (AwkStatBuff[Awk] ? AwkStatBuff[Awk].agl : 0) + (FullTalent ? TalentBlossomStats.agl : 0)) * (AwkStatsUp[Awk] ? AwkStatsUp[Awk].agl : 0)));
