...
var TalentBlossomStats = {"hp":0,"mp":0,"atk":30,"def":0,"agl":0,"wis":30,"move":0};
...
function applyStats() {
    ...
    $('#WIS').text(Math.floor((404 + (AwkStatBuff[Awk] ? AwkStatBuff[Awk].wis : 0) + (FullTalent ? TalentBlossomStats.wis : 0)) * (AwkStatsUp[Awk] ? AwkStatsUp[Awk].wis : 0)));
